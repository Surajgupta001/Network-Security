...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> Pipeline:
        """
        It initializes a KNNImputer object with the parameters defined in the constants file and
        returns a Pipeline object with the imputer as the only step.
        ...
        try:
            ...
            logging.info("Pipeline object created with KNNImputer as the only step")
            return processor
        except Exception as e:
            raise NetworkSecurityException(e, sys)
